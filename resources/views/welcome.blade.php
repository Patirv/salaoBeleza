...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <section id="depoimentos">
            ...
            <h2 class="text-green-900 text-3xl font-bold text-center pb-16" >Depoimentos de quem já <br>
                passou por aqui</h2>
            <div class="rounded shadow w-[544px] h-[264px] mb-56">
               <div class="px-14 pt-14 pb-6">
                ...
                Eu sou cliente do Beautysalon há 5 anos e não troco por nada! Certamente meu cabelo mudou muito depois
                 que comecei a tratar somente com produtos naturais e veganos. São profissionais incríveis e qualificados.
                </p>
                 </div>
               <div class="pl-14 flex flex-row items-center">
                <img class="h-10 w-10 rounded-full pr-2" src="{{asset('assets/imgs/hair.svg')}}" alt="avatar">


                <p class="text-gray-500">Nome do Usuario</p>
        ...
        <section id="contato" class="bg-gray-100">
            <div class="flex grid-cols-2  py-40 items-center justify-evenly">
                <div class="w-96">
                    ...
                    <button class="flex bg-green-500 text-gray-100 font-medium rounded px-8 py-4 gap-3"
                    >
                    <img src="{{asset('assets/imgs/whatsapp.svg')}}" alt="">
                        Entrar em contato
                    </button>
                </div>
                <div>
                    <p class=" flex gap-3 text-gray-500 text-lg pb-8">
                      <img src="{{asset('assets/imgs/phone.svg')}}" alt="">  11 99845-6754</p>
                    <p class=" flex gap-3 text-gray-500 text-lg pb-8">
                        <img src="{{asset('assets/imgs/map-pin.svg')}}" alt=""> R. Amauri Souza, 346</p>
                    <p class=" flex gap-3 text-gray-500 text-lg ">
                         <img src="{{asset('assets/imgs/mail.svg')}}" alt=""> contato@beautysalon.com</p>
                </div>
            </div>
        </section>
        ...
        <footer class="bg-green-500 ">
            <div class="flex grid-cols-2 py-16 items-center justify-evenly">
                <div class="w-[620px] pl-10 text-gray-100">
                    <img src="{{asset('assets/imgs/logo_footer.png')}}" alt="">
                        <p class="pt-6 pb-3">©2021 Beautysalon.</p>
                        <p>Todos os direitos reservados.</p>
                </div>
                <div class="flex items-center justify-evenly gap-8">
                    <img src="{{asset('assets/imgs/instagram.svg')}}" alt="">
                    <img src="{{asset('assets/imgs/facebook.svg')}}" alt="">
                    <img src="{{asset('assets/imgs/youtube.svg')}}" alt="">
                </div>
